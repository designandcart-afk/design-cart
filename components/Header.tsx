        ...
        <div className="flex items-center gap-4">
          {user && (
            <div className="hidden md:block">
              <button 
                aria-label="Search" 
                className="p-2 rounded-xl hover:bg-white hover:shadow-sm border border-transparent hover:border-[#2e2e2e]/10 transition-all duration-200"
              >
                <Search className="w-5 h-5 text-[#2e2e2e]/70 hover:text-[#d96857] transition-colors" />
              </button>
            </div>
          )}
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {user && isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-[#2e2e2e]/10 py-2 z-50">
                <Link 
                  href="/account" 
                  className="flex items-center gap-3 px-4 py-2 text-sm text-[#2e2e2e]/70 hover:text-[#2e2e2e] hover:bg-[#f8f7f4] transition-colors"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-2 text-sm text-[#d96857] hover:bg-[#f8f7f4] transition-colors"
                >
