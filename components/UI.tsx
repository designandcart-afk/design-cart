...
export function Select(props: React.ComponentProps<'select'>) {
  return (
    <div className="relative">
      <select {...props} className={`w-full border border-zinc-300 rounded-lg px-3 py-2 pr-8 bg-transparent text-[#2e2e2e] focus:outline-none focus:border-[#d96857] transition-colors cursor-pointer ${props.className||''}`} />
